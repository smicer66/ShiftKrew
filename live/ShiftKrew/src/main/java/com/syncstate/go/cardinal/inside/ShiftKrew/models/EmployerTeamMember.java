...
@Getter
@Setter
@Table(name = "employer_team_members")
public class EmployerTeamMember implements Serializable {

    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    private Long employerTeamMemberId;

    @Column(name = "employeeUserId", nullable = false)
    private Long employeeUserId;

    @Column(name = "employerTeamId", nullable = false)
    private Long employerTeamId;
